...
internal enum Asset {
  internal enum Colors {
    internal enum Background {
      internal static let wdBackground = ColorAsset(name: "wdBackground")
    }
    ...
    internal enum Primary {
      internal static let wildBlueYonder = ColorAsset(name: "WildBlueYonder")
      internal static let wdGreen = ColorAsset(name: "wdGreen")
      internal static let wdPrimary = ColorAsset(name: "wdPrimary")
      internal static let wdSecondary = ColorAsset(name: "wdSecondary")
    }
  ...
  internal enum Images {
    internal static let j118WsEx1 = ImageAsset(name: "J118-WS-EX-1")
